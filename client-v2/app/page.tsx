    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-slate-950">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary-900/80 via-slate-950 to-slate-950" />
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-primary-500/10 rounded-full blur-[150px]" />
          <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-accent-500/8 rounded-full blur-[120px]" />
          {/* Grid pattern */}
        ...
        <div className="section relative py-20 md:py-32 lg:py-40">
          <div className="max-w-4xl mx-auto text-center">
            <FadeIn>
              <p className="text-primary-400 text-sm font-semibold tracking-widest uppercase mb-6">
                Trusted by 10,000+ event-goers
              </p>
            </FadeIn>

            <FadeIn delay={0.08}>
              <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-5 leading-[1.08] tracking-tight">
                Discover live events.
                <br />
                <span className="bg-gradient-to-r from-accent-400 via-accent-300 to-amber-300 bg-clip-text text-transparent">
                  Buy with confidence.
                </span>
              </h1>
            </FadeIn>
            ...
            <div className="mt-20 max-w-3xl mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/5 rounded-2xl overflow-hidden border border-white/5">
                {[
                  ...
                  <div key={stat.label} className="flex items-center gap-3 px-5 py-4 bg-white/[0.02]">
                    ...
                    <div>
                      <p className="font-heading text-lg font-bold text-white tabular-nums leading-tight">{stat.value}</p>
      ...
      <section className="section py-16 border-b border-slate-100 dark:border-slate-800/50">
        ...
        <StaggerContainer className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
          {[
            { name: 'Concerts', icon: 'M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-.99-3.467l2.31-.66a2.25 2.25 0 001.632-2.163zm0 0V2.25L9 5.25v10.303m0 0v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 01-.99-3.467l2.31-.66A2.25 2.25 0 009 15.553z', q: 'concert' },
            { name: 'Sports', icon: 'M12 8.25v-1.5m0 1.5c-1.355 0-2.697.056-4.024.166C6.845 8.51 6 9.473 6 10.608v2.513m6-4.871c1.355 0 2.697.056 4.024.166C17.155 8.51 18 9.473 18 10.608v2.513M15 8.25v-1.5m-6 1.5v-1.5m12 9.75l-1.5.75a3.354 3.354 0 01-3 0 3.354 3.354 0 00-3 0 3.354 3.354 0 01-3 0 3.354 3.354 0 00-3 0 3.354 3.354 0 01-3 0L3 16.5m15-3.379a48.474 48.474 0 00-6-.371c-2.032 0-4.034.126-6 .371m12 0c.39.049.777.102 1.163.16 1.07.16 1.837 1.094 1.837 2.175v5.169c0 .621-.504 1.125-1.125 1.125H4.125A1.125 1.125 0 013 20.625v-5.17c0-1.08.768-2.014 1.837-2.174A47.78 47.78 0 016 13.12M12.265 3.11a.375.375 0 11-.53 0L12 2.845l.265.265zm-3 0a.375.375 0 11-.53 0L9 2.845l.265.265zm6 0a.375.375 0 11-.53 0L15 2.845l.265.265z', q: 'sports' },
            { name: 'Conference', icon: 'M4.26 10.147a60.438 60.438 0 00-.491 6.347A48.62 48.62 0 0112 20.904a48.62 48.62 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.636 50.636 0 00-2.658-.813A59.906 59.906 0 0112 3.493a59.903 59.903 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5', q: 'conference' },
            { name: 'Theatre', icon: 'M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z', q: 'theatre' },
            { name: 'Festival', icon: 'M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.047 8.287 8.287 0 009 9.601a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z', q: 'festival' },
            { name: 'Workshop', icon: 'M11.42 15.17l-5.25 5.25a.75.75 0 01-1.06 0l-3.5-3.5a.75.75 0 010-1.06l5.25-5.25m5.06-3.5l3.5 3.5a.75.75 0 010 1.06l-5.25 5.25m-10.06 0L2.25 12 12 2.25l9.75 9.75', q: 'workshop' },
          ].map((cat) => (
            <StaggerItem key={cat.name}>
              <Link
                href={`/tickets?q=${cat.q}`}
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-slate-950">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-accent-900/40 via-slate-950 to-slate-950" />
        ...
        <div className="section relative py-20">
          <div className="max-w-3xl mx-auto text-center">
            <FadeIn>
              <p className="text-accent-400 text-sm font-semibold tracking-widest uppercase mb-4">For sellers</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link href="/tickets" className="btn btn-lg border border-slate-700 text-slate-300 hover:bg-slate-800 font-semibold cursor-pointer">
                  See what&apos;s selling
                </Link>
              </div>
            </FadeIn>
